      ...
      {preview ? (
        <>
          <p>
            ...
            {' '}
            <a href={`/api/exitPreview/${object.id}`}>
              Exit preview mode.
            </a>
          </p>
          <h2>Actor #{object.id}: {object.name}</h2>
          <a
        ...
        <>
          <p>
            ...
            {' '}
            <a href={`/api/enterPreview/${object.id}`}>
              Enter preview mode.
            </a>
          </p>
          <h2>Show #{object.id}: {object.name}</h2>
          <a
            href={`https://api.tvmaze.com/shows/${object.id}`}
            target='_blank'>
