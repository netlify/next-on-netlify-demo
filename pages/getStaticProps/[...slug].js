...
const CatchAllShow = ({ show, slug }) => (
  <>
    ...
    <p>
      This page uses getStaticProps() to fetch a TV show from an API.<br/>
    ...
    <ul>
      ...
      <li>
        <Link href='/getStaticProps/[...slug]' as='/getStaticProps/143/silicon/valley'>
          <a>/getStaticProps/143/silicon/valley</a>
        </Link>
      </li>
      <li>
        <Link href='/getStaticProps/[...slug]' as='/getStaticProps/490/star/trek'>
      ...
      <li>
        <Link href='/getStaticProps/[...slug]' as='/getStaticProps/361/saturday/night/live'>
          <a>/getStaticProps/361/saturday/night/live</a>
        </Link>
      </li>
      <li>
        <Link href='/getStaticProps/[...slug]' as='/getStaticProps/6544/sesame/street'>
