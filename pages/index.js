...
const Index = () => (
  <>
    ...
    <div style={{ textAlign: 'center' }}>
      ...
      {' '}
      <a href="https://www.npmjs.com/package/next-on-netlify" rel="nofollow">
        <img src="https://img.shields.io/npm/dt/next-on-netlify" alt="NPM downloads" />
      </a>
      {' '}
      <a href="https://www.cypress.io/" rel="nofollow">
        <img src="https://img.shields.io/badge/tested%20with-Cypress-04C38E.svg" alt="Tested with Cypress.io" />
      </a>
    </div>
    ...
    <ul>
      ...
      <li>
        <Link href='/getInitialProps/[...slug]' as='/getInitialProps/83/catch/all/routing'>
    ...
    <ul>
      ...
      <li>
        <Link href='/getServerSideProps/[...slug]' as='/getServerSideProps/590/catch/all/routing'>
          <a>with catch-all routing</a>
        </Link>
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <Link href='/getStaticProps/[...slug]' as='/getStaticProps/1719/mr/bean'>
          <a>with catch-all routing</a>
        </Link>
      </li>
      <li>
        <Link href='/getStaticProps/withFallback/[id]' as='/getStaticProps/withFallback/5'>
    ...
    <ul>
      ...
      <li>
        <a href='/api/175/catch/all'>
          catch-all endpoint
        </a>
      </li>
      <li>
        <a href='/api/redirect'>
          with redirect header
        </a>
      </li>
      <li>
        <a href='/api/xml'>
